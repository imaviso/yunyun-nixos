    ...
    settings =
      ...
      // {
        core = {
          ...
          vwidth = settings.workspaces.gridWidth;
          vheight = settings.workspaces.gridHeight;
          preferred_decoration_mode = "server";
        };
        input = {
          xkb_layout = settings.input.keyboardLayout;
          mouse_accel_profile = settings.input.accelProfile;
          kb_repeat_delay = settings.input.repeatDelay;
          kb_repeat_rate = settings.input.repeatRate;
        };
        autostart = {
        ...
        command = {
          ...
          command_terminal = settings.apps.terminalAlt;
          binding_launcher = "<super> KEY_D";
          command_launcher = "dms ipc call spotlight toggle";
          binding_file_manager_term = "<super> KEY_E";
          command_file_manager_term = "${settings.apps.terminalAlt} -e '${settings.apps.fileManagerTUI}' ${settings.apps.fileManagerTUI}";
          binding_file_manager = "<super> <shift> KEY_E";
          command_file_manager = settings.apps.fileManager;
        ...
        switcher = {
          ...
          speed = settings.animation.duration;
        };
        expo = {
